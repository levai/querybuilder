...
export function useRuleGroup(options: UseRuleGroupPathOptions) {
  ...
  const classNames = computed(() => ({
    ...
    addRule: clsx(standardClassnames.addRule, classNamesProp.value?.actionElement, classNamesProp.value?.addRule),
    addGroup: clsx(standardClassnames.addGroup, classNamesProp.value?.actionElement, classNamesProp.value?.addGroup),
    combinators: clsx(suppressStandardClassnames.value || standardClassnames.combinators, classNamesProp.value?.valueSelector, classNamesProp.value?.combinators),
    notToggle: clsx(suppressStandardClassnames.value || standardClassnames.notToggle, classNamesProp.value?.notToggle),
    cloneGroup: clsx(standardClassnames.cloneGroup, classNamesProp.value?.actionElement, classNamesProp.value?.cloneGroup),
    lockGroup: clsx(suppressStandardClassnames.value || standardClassnames.lockGroup, classNamesProp.value?.actionElement, classNamesProp.value?.lockGroup),
    muteGroup: clsx(suppressStandardClassnames.value || standardClassnames.muteGroup, classNamesProp.value?.actionElement, classNamesProp.value?.muteGroup),
